...
class JokeController: NSObject {
    ...
    let jokes = [
        ["It was an emotional wedding", "Even the cake was in tiers 🎂", "Did you hear the joke about the German sausage?", "It was the wurst 🌭", "Yesterday a clown held the door open for me", "I thought it was a nice Jester 🤡"],
